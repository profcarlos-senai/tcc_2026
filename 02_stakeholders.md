...
Identifica todos os papéis humanos que terão contato com a solução, descrevendo suas responsabilidades, nível de conhecimento técnico e grau de autoridade no projeto.

#### 2.2 - [Necessidades e Expectativas](2.2_necessidades_expectativas.md)

Lista o levantamento bruto de desejos e dores coletados com os usuários (via entrevistas, questionários ou observação), traduzidos em exigências formais.

#### 2.3 - [Cenários de Operação](2.3_cenarios_de_operacao.md)

Apresenta histórias narrativas do dia a dia mostrando como os usuários irão interagir com a solução dentro do seu ambiente de trabalho ou rotina real.
